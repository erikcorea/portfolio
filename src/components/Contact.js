			...
			<div className='contact-container'>
                ...
                <div className="contact-info">
                    <div id="linkedin">
                        ...
                        <a href="https://www.linkedin.com/in/erik-correa/">linkedin/erik-correa</a>
                    </div>
                    <div id="email">
				        <img className='contact-logo' src={email} alt='linkedin' />
                        <a href="https://mail.google.com/mail/u/0/?view=cm&to=erikcorrea444@gmail.com&fs=1&tf=1">erikcorrea444@gmail.com</a>
                    </div>
                    <div id="phone">
